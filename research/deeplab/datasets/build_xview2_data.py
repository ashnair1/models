...
tf.app.flags.DEFINE_string('xview2_root',
                           '/home/an1/deeplabv3plus/data/xView2',
                           'xView2 dataset root folder.')

tf.app.flags.DEFINE_string(
    'output_dir',
    '/home/an1/deeplabv3plus/data/xView2/tfrecord',
...
def _get_files(data, dataset_split):
  ...
  search_files = os.path.join(
      FLAGS.xview2_root, _FOLDERS_MAP[data], dataset_split, pattern)
